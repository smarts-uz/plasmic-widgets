...
import sty from "./PlasmicCountdownNumber.module.css"; // plasmic-import: uwsmRU9lnbQw/css
...
function PlasmicCountdownNumber__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__bEngc)}>
        {renderPlasmicSlot({
          defaultContents: "42",
          value: args.number,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__uIvoB)}>
        {renderPlasmicSlot({

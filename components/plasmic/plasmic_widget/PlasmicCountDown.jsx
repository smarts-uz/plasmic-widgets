...
import CountdownNumber from "../../CountdownNumber"; // plasmic-import: uwsmRU9lnbQw/component
...
import sty from "./PlasmicCountdown.module.css"; // plasmic-import: rzAVuPbPRk8j/css
...
function PlasmicCountdown__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      >
        <CountdownNumber
          className={classNames("__wab_instance", sty.countdownNumber__tfCxp)}
          number={
            <React.Fragment>
              {(() => {
                try {
        ...
        <CountdownNumber
          className={classNames("__wab_instance", sty.countdownNumber___87VIm)}
          number={
            <React.Fragment>
              {(() => {
                try {
        ...
        <CountdownNumber
          className={classNames("__wab_instance", sty.countdownNumber__zmnlj)}
          number={
            <React.Fragment>
              {(() => {
                try {
        ...
        <CountdownNumber
          className={classNames("__wab_instance", sty.countdownNumber___8Bgt)}
          number={
            <React.Fragment>
              {(() => {
                try {

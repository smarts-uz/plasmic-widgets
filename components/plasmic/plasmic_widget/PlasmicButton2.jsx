...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: SSID6rhNgwX4/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Kkg8Tg209b3_/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: hL2zmE2wQE3H/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__isa89)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__ka6Wd)}
                role={"img"}
              />
            ),
